...
include C:/IPG/carmaker/win64-10.2.2/include/MakeDefs.win64
...
MAKECMD         = "C:/IPG/carmaker/win64-10.2.2/bin/cmmake"
HOST            = ANY
BUILD           = yes
...
MODEL		= BrakeJenkins
WRAPPER		= BrakeJenkins_wrap
CLASS		= Brake
DESCRIPTION	= "BrakeJenkins"
MAINMODEL	= ""
PARAMID		= 1
SYMBOLS		= ""
...
INC_CFLAGS	+= -I$(subst \,/,"C:\CarMaker_Projects\CM10\JenkinsTest\Git\src")
INC_CFLAGS	+= -I$(subst \,/,"C:\CarMaker_Projects\CM10\JenkinsTest\Git\src\BrakeJenkins_CarMaker_rtw")
INC_CFLAGS	+= -I$(subst \,/,"C:\CarMaker_Projects\CM10\JenkinsTest\Git\src_cm4sl")
